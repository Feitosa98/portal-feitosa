...
import { Receipt, Download, ArrowLeft } from 'lucide-react-native';
...
export default function ReceiptsScreen() {
    ...
    const renderItem = ({ item }: { item: ReceiptData }) => (
        <View style={styles.card}>
            <View style={styles.cardHeader}>
                ...
                <View style={styles.headerInfo}>
                    <Text style={styles.number}>Recibo #{item.number}</Text>
            ...
            {item.pdfPath && (
                <TouchableOpacity
                    ...
                    onPress={() => handleDownload(item.pdfPath!)}
                >
        ...
        <SafeAreaView style={styles.container}>
            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.center}>
                            <Text style={styles.emptyText}>Nenhum recibo encontrado</Text>
                        </View>
                    }
                />
            )}
