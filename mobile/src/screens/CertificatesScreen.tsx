...
import { FileCheck, Download, ArrowLeft, Upload, Trash2 } from 'lucide-react-native';
...
export default function CertificatesScreen() {
    ...
    const handleUpload = async () => {
        try {
            ...
            // FormData needs special handling in React Native
            ...
            formData.append('clientId', user.id); // Assuming user.id exists, might need adjustment based on AuthContext
            ...
            Alert.alert('Sucesso', 'Certificado enviado com sucesso!');
            loadDocuments();
        } catch (error) {
                ...
                { text: 'Cancelar', style: 'cancel' },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert('Erro', 'Não foi possível apagar o documento.');
                        }
                    }
                }
            ]
            ...
            <View style={styles.cardHeader}>
                <View style={styles.headerLeft}>
                    ...
                    <View style={styles.headerInfo}>
                        ...
                        <Text style={styles.size}>{item.fileSize} bytes</Text>
                    </View>
                </View>
